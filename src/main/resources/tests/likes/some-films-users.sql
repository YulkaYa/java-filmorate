...
values (0,'1988-12-28', 'descriptionZeroFilm', 'nameOfZeroFilm', 34L, 1);

merge into films (film_id, releaseDate, description, name, duration, mpa_id)
values (1,'1989-12-28', 'descriptionFirstFilm', 'nameOfFirstFilm', 35L, 2);

merge into films (film_id, releaseDate, description, name, duration, mpa_id)
values (2,'1990-12-28', 'descriptionSecondFilm', 'nameOfSecondFilm', 38L, 3);

merge into films (film_id, releaseDate, description, name, duration, mpa_id)
values (3,'1990-12-28', 'descriptionThirdFilm', 'nameOfThirdFilm', 39L, 4);

merge into films (film_id, releaseDate, description, name, duration, mpa_id)
values (4,'1990-12-28', 'descriptionFourFilm', 'nameOfFourFilm', 50L, 4);
